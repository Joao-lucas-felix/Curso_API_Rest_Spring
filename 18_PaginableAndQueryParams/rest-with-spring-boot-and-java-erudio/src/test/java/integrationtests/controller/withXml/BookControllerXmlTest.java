...
public class BookControllerXmlTest extends AbstractIntegrationTest {
    ...
    public void testFindAll() throws JsonProcessingException {
        var result = given()
                ...
                .extract()
                .body().asString();
        List<BookDto> bookDtosDtos = mapper.readValue(result, new TypeReference<List<BookDto>>() {});
        BookDto bookOne = bookDtosDtos.getFirst();
//        "id": 1,
...
//                "title": "JavaScript",
        ...
        BookDto bookTwo = bookDtosDtos.get(3);
...
//                "title": "Implantando a governança de TI",
        ...
        BookDto bookThree = bookDtosDtos.get(14);
        ...
        bookDtosDtos.forEach(System.out::println);
    }
